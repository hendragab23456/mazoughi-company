...
<head>
    ...
    <title>إضافة مشروع - المزوغي للمقاولات</title>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description"
                          rows="5"
                          placeholder="وصف المشروع وأي ملاحظات مهمة"
                          class="w-full border-gray-300 rounded-xl">{{ old('description') }}</textarea>
